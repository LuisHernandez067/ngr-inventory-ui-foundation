...
export const conteoFixtures: Conteo[] = [
  ...
  {
    /** cnt-005: conteo pausado — almacén norte, items con cantidadEsperada pero sin cantidadContada en algunos */
    id: 'cnt-005',
  ...
  {
    /** cnt-006: conteo completado con discrepancias — positivas y negativas, sin ajuste aún */
    id: 'cnt-006',
    ...
    items: [
      ...
      {
        /** Sin diferencia: coincide exactamente */
        id: 'cnt-006-3',
        productoId: 'prod-009',
        productoCodigo: 'SSD-500-001',
        productoNombre: 'Disco SSD 500GB',
